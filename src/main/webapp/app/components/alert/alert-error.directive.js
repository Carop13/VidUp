(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('vidUpApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-vidUpApp-error');
                var entityKey = httpResponse.headers('X-vidUpApp-params');
                if (errorHeader) {
